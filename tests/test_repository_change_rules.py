...
from mlx_ci.repository.change_rules import ChangeContext, ChangeDetector, PathPattern
from mlx_ci.repository.planning import Delegator, _parse_name_status
...
def test_rename_includes_old_and_new_paths():
    output = (
        b"R100\0models/old/model.py\0models/new/model.py\0M\0README.md\0"
    )
